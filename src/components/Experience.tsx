...
const Details = ({ position, company, companyLink, time, address, work }: any) => {
    ...
    return (
        <li ref={ref} className='my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col justify-between items-center'>
            ...
            >
                <h3 className='capitalize font-bold text-2xl dark:text-light'>{position}&nbsp;<a href={companyLink} className='text-red capitalize'>@{company}</a></h3>
...
<Details
position="Front-End WebDeveloper"
company="PIAIC "
companyLink="https://www.piaic.org/"
time="2024-Present"
address="Lahore, Pk"
